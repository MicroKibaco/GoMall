package com.github.microkibaco.gomall.db;
...
public class SPManager {
     ...
     * Preference文件名
     */
    private static final String SHARE_PREFERENCES_NAME = "mall.pre";
    /**
     * 上次基金更新时间
     */
    ...
    private SPManager() {
        sp = MallApplication.getMallApplication().getSharedPreferences(SHARE_PREFERENCES_NAME, Context.MODE_PRIVATE);
        editor = sp.edit();
    }
